...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=2e00cfe75ad365584acc76b588be8d74&libraries=services"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
...
function getListItem(index, places) {
    ...
    itemStr = '<span class="markerbg marker_' + (index+1) + '"></span>' +
                ...
                '   <a href= "'+ places.place_url + '" target="_blank" >'+places.place_url+'</a>';
