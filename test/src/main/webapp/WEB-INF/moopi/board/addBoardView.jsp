...
<script>
	...
	function fncAddBoard() {
		...
		$("form.form-horizontal3").attr("method", "POST").attr("action",
				"/board/addBoard").submit();
		...
		<div class="container">
			...
			<div class="col-xs-12 col-sm-12 col-md-12"
				...
				<h3 class="head_title" data-edit="true"
					...
					<span class="fsize20"><strong> ${boardCategory eq 'Moopi' ? '공지글 작성' : 'QnA 작성'}
					</strong></span>
				</h3>
			...
			<form class="form-horizontal3" name="detailForm"
				...
				<input type="hidden" id="boardWriter.userId"
					...
					type="hidden" id="boardCategory" name="boardCategory"
					value="${boardCategory eq 'Moopi' ? '1' : '2' }">

				<div class="form-group">
					<div style="padding-bottom: 30px;">
						<input type="text" class="form-control" id="boardName"
							name="boardName" style="width: 90%;" placeholder="제목을 입력해주세요.">
					</div>
				</div>
				...
				<c:if test="${boardCategory eq 'QnA' }">
					<div class="form-group" style="padding-top: 30px;">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" id="boardPassword"
								name="boardPassword">
						</div>
					</div>
				</c:if>
