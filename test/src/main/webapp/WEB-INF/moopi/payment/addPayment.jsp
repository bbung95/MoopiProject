                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="card mb-5 mb-xl-0">
                                <div class="card-body p-5">
                                    ...
                                    <div class="d-grid">
                                     <button class="btn btn-outline-primary" type="button" id="check_module" onclick="javascript:pay(1000)" name="cp_item">선택</button>
						...
						<div class="col-lg-6 col-xl-4">
                            <div class="card mb-5 mb-xl-0">
                                <div class="card-body p-5">
                                    ...
                                    <div class="d-grid">
                                     <button class="btn btn-outline-primary" type="button" id="check_module" onclick="javascript:pay(2000)" name="cp_item">선택</button>
                                  <!--    <input type="hidden" name="cp_item" value="1000"></div>  -->
                                	<!--<label class="box-radio-input"><input type="button" class="btn btn-outline-primary" name="cp_item" id="check_module" value="1000"><span>1,000원</span></label>-->
                                </div>
                            </div>
						...
						<div class="col-lg-6 col-xl-4">
                            <div class="card mb-5 mb-xl-0">
                                <div class="card-body p-5">
                                    ...
                                    <div class="d-grid">
                                     <button class="btn btn-outline-primary" type="button" id="check_module" onclick="javascript:pay(3000)" name="cp_item">선택</button>
                                  <!--    <input type="hidden" name="cp_item" value="1000"></div>  -->
                                	<!--<label class="box-radio-input"><input type="button" class="btn btn-outline-primary" name="cp_item" id="check_module" value="1000"><span>1,000원</span></label>-->
                                </div>
                            </div>
		   ...
		   //var price = $(this).attr("price");
			...
			IMP.request_pay({
				...
				if (rsp.success) {
					...
					document.location.href="/flash/addPaymentView";//아란트창 확인후 이동할 url
					$.ajax({ 
						type: "POST" ,
