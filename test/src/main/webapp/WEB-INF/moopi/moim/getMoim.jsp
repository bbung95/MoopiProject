					...
					<div id="left" class="col-xs-3 col-md-3">
						<div style="text-align: center;">
							<img id="moimThumbnail" src="/images/uploadFiles/${moim.mmFile}"
								data-attach="true" data-fixedsize="true" data-fixed-width="300"
								style="width: 300px;" />
						</div>
						<%-- 	<p>모임넘버:${moim.mmNo}</p> --%>

						<div id="information">Information</div>
						<br> <span class="jumbotrons"><i
							class="bi bi-people-fill"></i> ${moim.mmCurrentCount} /
							${moim.mmMaxCount}</span> <br> <span class="jumbotrons">창립일
						...
						<br>
						<button type="button" class="btn btn-primary addReportMoim"
							style="margin-top: 10px">신고</button>
					</div>
									...
									<div class="our-team">
										<div class="picture">
											<a href="/user/getMyHome?userId=${member.mmUser.userId}">
												<img class="img-fluid"
												src="/images/uploadFiles/${member.mmUser.profileImage}">
											</a>
										</div>
