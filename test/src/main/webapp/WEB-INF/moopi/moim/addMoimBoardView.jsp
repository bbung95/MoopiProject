...
<script>
	...
	function fncAddBoard() {
		...
		$("form.form-horizontal2").attr("method", "POST").attr("action",
				"/moim/addBoard").submit();
			...
			<div class="container">
				...
				<div class="col-xs-12 col-sm-12 col-md-12">
					<h3 class="head_title" data-edit="true"
						...
						<span class="fsize20"><strong>Write</strong></span>
					</h3>
				...
				<!--  뉴폼 -->
				<!-- form Start /////////////////////////////////////-->
				<form class="form-horizontal2" name="detailForm"
					...
					<input type="hidden" id="boardMoimNo" name="boardMoimNo"
						value="${boardMoimNo }">
