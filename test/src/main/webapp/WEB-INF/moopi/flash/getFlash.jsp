						...
						<div class="col-lg-9">
							...
							<c:if test="${dbUser.userId == flash.flashConstructor.userId}">
								<button type="button" class="btn btn-light"
									data-bs-toggle="modal" data-bs-target="#staticBackdrop">번개수정</button>
							</c:if>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form class="form-horizontal" name="detailForm"
							...
							<input type="hidden" id="userId" name="userId"
								value="${flash.flashConstructor.userId}"> <input
								type="hidden" id="flashNo" name="flashNo"
								value="${flash.flashNo}">
							<div class="form-group">
								...
								<div class="col-sm-20">
									<input type="text" class="form-control" id="flashName"
										name="flashName" placeholder="번개명" value="${flash.flashName}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-40">
									<textarea style="resize: none" class="form-control"
										id="flashContent" name="flashContent" placeholder="500자이내"
										value="${flash.flashContent}"></textarea>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-20">
									<input type="datetime-local" class="form-control"
										id="flashTime" name="flashTime" placeholder="만남시간"
										value="${flash.flashTime}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-20">
									<select class="form-control" id="flashInterest"
										name="flashInterest" value="${flash.flashInterest}">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary"
							onClick="fncUpdateFlash()">수정</button>
					</div>
				</div>
			</div>
		</div>
